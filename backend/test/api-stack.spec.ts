...
describe('APIStack CDK Integration Tests', () => {
  ...
  test('should create DynamoDB data sources', { timeout: 60000 }, () => {
    ...
    // Verify data sources exist (2 DynamoDB + 7 Lambda)
    ...
    expect(dataSources.length).toBe(17);
    ...
    expect(lambdaSources.length).toBe(15); // Stripe Checkout + 6 Vocabulary Lambdas + 8 Training Lambdas
  });
  ...
  test('should have correct resource counts', { timeout: 60000 }, () => {
    ...
    template.resourceCountIs('AWS::AppSync::DataSource', 17); // users, subscriptions, 7 Vocabulary Lambdas, and 8 Training Lambdas
