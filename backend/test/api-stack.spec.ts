...
describe('APIStack CDK Integration Tests', () => {
  ...
  test('should create DynamoDB data sources', { timeout: 60000 }, () => {
    ...
    // Verify data sources exist (2 DynamoDB + 22 Lambda)
    template.resourceCountIs('AWS::AppSync::DataSource', 24);
    ...
    expect(dataSources.length).toBe(24);
    ...
    expect(lambdaSources.length).toBe(22); // Stripe Checkout + 6 Vocabulary Lambdas + 1 AppInfo + 12 Training Lambdas + 1 Abort Training + 1 Overview Statistics
  });
